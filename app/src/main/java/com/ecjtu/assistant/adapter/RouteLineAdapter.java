...
public class RouteLineAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (mtype) {
            ...
            case WALKING_ROUTE:
            case BIKING_ROUTE:
                holder.name.setText(routeLines.get(position).getStarting().getTitle()+"===="+routeLines.get(position).getTerminal().getTitle());
                ...
                holder.dis.setText("距离大约是：" + routeLines.get(position).getDistance()/1000 + "公里");
                break;
