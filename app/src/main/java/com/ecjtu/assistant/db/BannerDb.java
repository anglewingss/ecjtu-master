...
public class BannerDb {
    ...
    protected static final String TAG = BannerDb.class.getSimpleName();

    protected static final int DB_VERSION = 5;
    protected static final String DB_NAME = "banner_db";
    protected static final String DB_PRIMARY_KEY = "_id";
    protected static final String DB_TABLE_NAME = "banner";
    ...
    protected static final BannerDb mInstance = new BannerDb();
