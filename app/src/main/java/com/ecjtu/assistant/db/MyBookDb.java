...
public class MyBookDb {
    ...
    protected static final String TAG = MyBookDb.class.getSimpleName();

    protected static final int DB_VERSION = 1;
    protected static final String DB_NAME = "mybook_db";
    protected static final String DB_PRIMARY_KEY = "_id";
    protected static final String DB_TABLE_NAME = "mybook";

   public static final String DB_TABLE_COLUMN_address = "address";
   public static final String DB_TABLE_COLUMN_title= "title";
   public static final String DB_TABLE_COLUMN_DATE = "date";
   public static final String DB_TABLE_COLUMN_borrow_time = "borrow_time";
   public static final String DB_TABLE_COLUMN_back_time = "back_time";
   public static final String DB_TABLE_COLUMN_num = "num";
   public static final String DB_TABLE_COLUMN_remain_day= "remain_day";
    ...
    protected static final MyBookDb mInstance = new MyBookDb();

    private final String DB_TABLE_CREATE_SQL = "create table " + DB_TABLE_NAME + " (_id integer primary key autoincrement, "
            + DB_TABLE_COLUMN_title + " text, "
            + DB_TABLE_COLUMN_address + " text, "
            + DB_TABLE_COLUMN_borrow_time + " text, "
            + DB_TABLE_COLUMN_back_time + " text, "
            + DB_TABLE_COLUMN_num + " text, "
            + DB_TABLE_COLUMN_remain_day + " text, "
    ...
    public static MyBookDb getInstance() {
        return mInstance;
    }
    ...
    public boolean insert(Record note) {
        ...
        values.put(DB_TABLE_COLUMN_address, note.address);
        values.put(DB_TABLE_COLUMN_back_time, note.backtime);
        values.put(DB_TABLE_COLUMN_borrow_time, note.borrowtime);
        values.put(DB_TABLE_COLUMN_remain_day, note.remainday);
        values.put(DB_TABLE_COLUMN_num, note.num);
    ...
    protected List<Record> extract(int offset, Cursor cursor) {
        ...
        do {
            ...
            note.address = cursor.getString(cursor.getColumnIndex(DB_TABLE_COLUMN_address));
            note.remainday = cursor.getString(cursor.getColumnIndex(DB_TABLE_COLUMN_remain_day));
            note.backtime = cursor.getString(cursor.getColumnIndex(DB_TABLE_COLUMN_back_time));
            note.borrowtime = cursor.getString(cursor.getColumnIndex(DB_TABLE_COLUMN_borrow_time));
            note.num = cursor.getString(cursor.getColumnIndex(DB_TABLE_COLUMN_num));
            notes.add(note);
