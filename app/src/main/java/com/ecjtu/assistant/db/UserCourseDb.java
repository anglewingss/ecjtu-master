...
public class UserCourseDb {
    ...
    protected static final String TAG = UserCourseDb.class.getSimpleName();
    ...
    protected static final String DB_TABLE_NAME = "usercourse";
    ...
    protected static final UserCourseDb mInstance = new UserCourseDb();
    ...
    private UserCourseDb() {
    }

    public static UserCourseDb getInstance() {
        return mInstance;
    }
    ...
    public List<Record> queryUserCourse(String condition) {
        Cursor cursor = mDB.query(DB_TABLE_NAME, null, condition, null, null, null,
                DB_DEFAULT_ORDERBY, null);
        return extract(0, cursor);
    }
